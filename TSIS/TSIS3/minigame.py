...
def main_menu():
    global username
    btn_play = ui.Button(100, 200, 200, 50, "START", (255, 150, 0), (0, 200, 0))
    btn_lead = ui.Button(100, 270, 200, 50, "LEADERBOARD", (255, 208, 64), (0, 100, 250))
    btn_sett = ui.Button(100, 340, 200, 50, "SETTINGS", (128, 128, 128), (200, 200, 0))
    btn_quit = ui.Button(100, 410, 200, 50, "EXIT", RED, (255, 0, 0))
    ...
    while True:
        ...
        title = font_title.render("RETRO CARS", True, WHITE)
        DISPLAYSURF.blit(title, (title.get_rect(center=(200, 50))))
        
        lbl = font_ui.render("Say your name:", True, WHITE)
